...
class AsyncLLM(StatelessLLMInterface):
    ...
    async def chat_completion(
        ...
        try:
            ...
            # Section 10: FAST vs DEEP reasoning routing
            user_texts = []
            for m in messages:
            ...
            deep_triggers = ["深入分析", "详细推导", "证明", "仔细计算", "推导", "一步一步推导", "deep think"]
            need_deep = any(t in user_text for t in deep_triggers)
            enable_thinking = need_deep
